# 🌈 next-theme - A Seamless Light and Dark Experience
...
After installing next-theme:

1. Launch the application.
2. Choose your preferred theme from the settings.
3. Your preference will be saved, ensuring the app remembers your choice next time you open it.

## 🔍 Troubleshooting

In case you experience issues:
...
We welcome contributions from everyone. If you wish to contribute to next-theme:
